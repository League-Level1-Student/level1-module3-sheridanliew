...
public class Jeopardy implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == firstButton) {
			...
			askQuestion("The League of ___ Programmers", "What is Amazing?", 200);
			firstButton.setText("");
		}
		...
		if (e.getSource() == secondButton) {
			...
			askQuestion("first number in code", "What is 0?", 400);
		...
		if (e.getSource() == thirdButton) {
			askQuestion("un-abbreviated form of GUI", "What is a Graphic User Interface?", 800);
			thirdButton.setText("");
		}
		if (e.getSource() == fourthButton) {
			askQuestion("name of this program", "What is Jeopardy?", 1000);
