...
public class BookOfIllusions extends MouseAdapter {
	...
	private void createBook() {
		...
		String OptIllusion = "06-Optical-Illusions-That-Will-Make-Your-Brain-Hurt_11066665-©mark.jpg";
		// 6. create a variable of type "JLabel" but don’t initialize it yet
		// 7. use the "loadImage..." methods below to initialize your JLabel
		label = loadImageFromComputer(OptIllusion);
	...
	public void mousePressed(MouseEvent e) {
		...
		String OptFeature = "opticalfeature.jpg";
		label = loadImageFromComputer(OptFeature);
		frame.add(label);
		// 14. pack the frame
		frame.pack();
	}
